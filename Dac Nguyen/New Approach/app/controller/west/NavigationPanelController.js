...
Ext.define('EmailPrototype.controller.west.NavigationPanelController', {
    ...
    'west.MailPanel',
    'west.TodoPanel',
    'west.NavigationPanel',
    'center.MailGridPanel',
    'center.TodoGridPanel',
    'east.InformationPanel',
     'center.PreviewPanel',
    ],
    ...
    init: function(application) {
        ...
        controller = me.createController('west.MailPanelController');
        controller = me.createController('west.TodoPanelController');
  ...
  getViewItems: function(){
    ...
    getViewConfig:function(){
        ...
        var viewId = me.getViewId('navigationpanel');
    ...
    onTreepanelExpand: function(p, eOpts) {
        ...
        containPanelCenter.add({xtype:'mailgridpanel'});
    ...
    onTodoPanelExpand: function(p, eOpts) {
        ...
        var containPanelCenter = mainpanel.down('container#contentpanelCenter');
        containPanelCenter.removeAll();
        containPanelCenter.add({xtype:'todogridpanel'});
    ...
    onFoldertreeSelect: function(rowmodel, record, index, eOpts) {
        ...
        var mailGrid = Ext.ComponentQuery.query('mailgridpanel')[0];
        //debugger;
    ...
    onTodoPanelSelect: function(rowmodel, record, index, eOpts) {
        ...
        var todoGrid = Ext.ComponentQuery.query('todogridpanel')[0];
