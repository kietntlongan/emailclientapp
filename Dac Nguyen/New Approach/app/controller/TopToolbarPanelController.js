/*
 * File: app/controller/TopToolbarPanelController.js
 *
...
Ext.define('EmailPrototype.controller.TopToolbarPanelController', {
    ...
    getViewConfig:function(){
        var me = this;
        var viewId = me.getViewId('toptoolbarpanel');
        cfg = {
            xtype: 'toptoolbarpanel',
            itemId: viewId
        }
        return cfg;
    },
   ...
   onBtnSearchClick: function(button, e, eOpts) {
      ...
      //  debugger;
        ...
        if(containPanelGrid.getXType() === 'mailgridpanel') {
         //   console.log('mailgrid');
          ...
          //      debugger;
            ...
            var searchStore = me.getStore('MailStore');
           ...
           // debugger;
            ...
            var searchStore = me.getStore('TodoStore');
            searchStore.loadData(arrayMessageResult, false);
            containPanelGrid.reconfigure(searchStore);
        }
    },
